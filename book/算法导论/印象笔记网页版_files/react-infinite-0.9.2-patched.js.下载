// Evernote dev note: patch includes cf43b4a from kevinfahy/react-infinite
...
module.exports={CONTAINER_HEIGHT_SCALE_FACTOR:"containerHeightScaleFactor"};
